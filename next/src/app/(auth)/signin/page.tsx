        ...
        <div className="w-full sm:max-w-md p-5 mx-auto">
          ...
          <form action={action}>
            ...
            <div className="mt-6">
              <button 
                type="submit" 
                className="w-full inline-flex items-center justify-center px-4 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold capitalize text-white hover:bg-emerald-700 active:bg-emerald-700 focus:outline-none focus:border-emerald-700 focus:ring focus:ring-emerald-200 disabled:opacity-25 transition"
                disabled={pending}
              >
                {pending ? '로그인 중...' : '로그인'}
              </button>
